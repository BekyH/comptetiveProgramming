 ...
 */
    ...
    public List<Integer> helper(TreeNode root){
        ...
        max = Collections.max(Arrays.asList(leftpair.get(0),max,root.val + leftpair.get(1),root.val,rightpair.get(0),root.val + rightpair.get(1),leftpair.get(1) + rightpair.get(1) + root.val));
